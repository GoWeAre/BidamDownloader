...
영상 주소를 붙여넣으면 MP4 로 저장하거나 MP3(192k) 로 추출해 주는 Windows 앱입니다.
국내외 주요 영상 · 스트리밍 사이트를 지원하며, 지원 여부는 주소를 넣어 보면 바로 알 수 있습니다.
...
- 일부 사이트는 날짜와 종류가 앞뒤로 붙은 파일명(`[YYMMDD] 사이트_제목_종류`)으로 저장됩니다.
- 성인 인증이 필요한 영상은 받을 수 없습니다.
